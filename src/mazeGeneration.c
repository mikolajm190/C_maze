...
int jump(int maze[][M][W], int visited[][M], int cellRow, int cellCol){
  ...
  if (wallInt < 100000) {
    ...
    if (cellRow + 1 > (N - 1) || visited[cellRow + 1][cellCol] == 1)
      return -1;
    else
      return 0;
  }
  //try jumping left
    ...
    if (cellCol - 1 < 0 || visited[cellRow][cellCol - 1] == 1)
      return -1;
    else
      return 1;
  }
    ...
    if (cellRow - 1 < 0 || visited[cellRow - 1][cellCol] == 1)
      return -1;
    else
      return 2;
  }
    ...
    if (cellCol + 1 > (M - 1) || visited[cellRow][cellCol + 1] == 1)
      return -1;
    else
      return 3;
  }
...
void dfs(int maze[][M][W], int visited[][M], int cellRow, int cellCol){
  ...
  if ((cellRow - 1 < 0 || visited[cellRow - 1][cellCol] == 1) &&
  (cellRow + 1 > N - 1 || visited[cellRow + 1][cellCol] == 1) &&
  (cellCol - 1 < 0 || visited[cellRow][cellCol - 1] == 1) &&
  (cellCol + 1 > M - 1 || visited[cellRow][cellCol + 1] == 1))
    return;
